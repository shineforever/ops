...
var Dealer = function(){
    ...
    this.resultFile = "suning_bx_"+moment().format("YYYY-MM-DD")+".txt";
    this.done = {};
...
Dealer.prototype.start = function(){
    this.init();
	//this.wgetList(["http://list.suning.com/0-431504-0-0-0-9017.html"]);//空调
	this.wgetList(["http://list.suning.com/0-244005-0-0-0-9017.html"]);
}
...
Dealer.prototype.processItem = function(err,result,$){
	...
	var detail = {
		...
		"series":dealstr(series)||"N/A", "doortype":dealstr(doortype)||"N/A", "url":result.uri,
