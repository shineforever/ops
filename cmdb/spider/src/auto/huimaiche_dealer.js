...
BdaSpider.prototype.init = function() {
	...
	// saveData("\ufeff店铺名称,店铺公司,地址,电话,评分,品牌,车型,人数,经销商数目,城市,城市代码,汽车id\n","dealer");
	fs.writeFileSync(this.resultFile, 
		"\ufeff店铺名称,店铺公司,地址,电话,评分,品牌,车型,人数,经销商数目,城市,城市代码,汽车id,URL\n");
...
BdaSpider.prototype.processTgDetail = function(error, result, $) {
	...
	try{
		...
		var brand = mts.length>1?mts[1]:"N/A";
